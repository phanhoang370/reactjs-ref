<?
	...
	function lib_SessionHandlerInit(){
		...
		include_once('PHP-MySQL-Session-Handler/MySqlSessionHandler.php');
		...
		//2017.03.29 14:47 허정진 수정
		@ini_set("session.cookie_lifetime", 0); // 초
		@ini_set("session.cache_expire", 60 * 24 * 100); // 분
		@ini_set("session.gc_maxlifetime", 60 * 60 * 24 * 100); // 초 for 100 days (60sec * 60mins * 24hours * 100days)
		session_start();
