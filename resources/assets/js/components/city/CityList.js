...
class CityList extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            columns: [
                {name: 'city_name', title: 'city_name'},
                {name: 'city_id', title: 'action'},
            ],
            ...
            currencyColumns: ['city_id'],
        };

        this.changeSorting = sorting => this.setState({sorting});
        this.changeEditingRowIds = editingRowIds => {
            console.log(this);
            // this.props.history.push(`/dashboard/city/${editingRowIds}`)
    ...
    CurrencyFormatter = data => {
        return (
            <div>
                <Link to={`/dashboard/city/edit/${data.value}`} > edit </Link> 
                <button onClick={() => this.deleteCity(data.value)}> delete </button>
            </div>
        )
    }
...
export default withStyles(styles, {name: 'ControlledModeDemo'})(CityList);
